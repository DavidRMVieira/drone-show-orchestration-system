...
public class DroneLanguagePluginImplVisitor extends DroneLanguagePluginBaseVisitor<Object> {
    ...
    @Override
    public Map<String, Object> visitInstancePoint(DroneLanguagePluginParser.InstancePointContext ctx) {
    ...
    @Override
    public Map<String, Object> visitInstanceArrayPoint(DroneLanguagePluginParser.InstanceArrayPointContext ctx) {
        String varName = ctx.variableName().getText();
    ...
    public DroneLanguage visitInstanceLightsOn(DroneLanguagePluginParser.InstanceLightsOnContext ctx) {
        if (ctx.COLORNAME() != null) {
            ...
            droneLanguage.addLightsOn(color);
        } else {
