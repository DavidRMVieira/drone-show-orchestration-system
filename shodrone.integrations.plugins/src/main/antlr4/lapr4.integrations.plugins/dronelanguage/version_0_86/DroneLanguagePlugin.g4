...
variableDecl: POSITION variableName EQUALS (vectorExpression) SEMICOLON #instancePosition |
            POSITION variableName EQUALS (arrayVectorExpression) SEMICOLON #instanceArrayPosition |
...
instruction
    ...
    | LIGHTSON (LEFTPARENTHESIS RIGHTPARENTHESIS)? SEMICOLON #instanceLightsOn
