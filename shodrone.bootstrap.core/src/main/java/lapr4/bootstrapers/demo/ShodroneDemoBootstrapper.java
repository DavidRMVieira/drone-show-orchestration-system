...
public class ShodroneDemoBootstrapper implements Action {
    ...
    public boolean execute() {
        ...
        final Action[] actions = { new ShodroneUsersBootstrapper(), new CustomerBootstrapper(), new ShowRequestBootstrapper(),
                new FigureCategoryBootstrapper(), new FigureBootstrapper(), new DroneModelBootstrapper(), new DroneBootstrapper()};
