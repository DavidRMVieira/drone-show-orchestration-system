 ...
 */
public class ListCustomerProposalsRequest extends ListShowProposalsRequest {
    ...
    public ListCustomerProposalsRequest(final GetShowInfoController controller, Authenticator authenticationService,
    ...
    public String execute() {
        ...
        // execution
        try {
            final Iterable<ShowProposalDTO> proposalsDTO = getShowInfoController.listCustomerShowProposals();
