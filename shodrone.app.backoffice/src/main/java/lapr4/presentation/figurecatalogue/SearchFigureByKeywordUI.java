...
public class SearchFigureByKeywordUI extends AbstractListUI<FigureDTO> {
    ...
    protected Iterable<FigureDTO> elements() {
        ...
        return controller.searchByKeyword(keyword);
    }
    ...
    protected String emptyMessage() {
        return "No figures with specified keyword found!\n";
    }

    @Override
    public String headline() {
        return "Figures by specified keyword";
    }
}
