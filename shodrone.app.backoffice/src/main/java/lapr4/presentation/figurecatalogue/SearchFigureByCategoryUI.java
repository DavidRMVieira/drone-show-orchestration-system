...
public class SearchFigureByCategoryUI extends AbstractListUI<FigureDTO> {
    ...
    protected Iterable<FigureDTO> elements() {
        ...
        return controller.searchByCategory(category);
    }
    ...
    protected String emptyMessage() {
        return "No figures with specified category found!\n";
    }

    @Override
    public String headline() {
        return "Figures by specified category";
    }
}
